...
export class CalendarsettingComponent implements OnInit {
  ...
  calViews = [{Id: 1,name:'Resource By Day',Type:"resourceTimeline"},{Id: 2,name:'Day By Resource',Type:"resourcegridView"},{Id: 3,name:'Day By Activity Type',Type:"resourcegridView"},{Id: 4,name:'Day By Time',Type:"restimelineDay"}];
